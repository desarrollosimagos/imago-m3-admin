    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            ...
            <form class="m-t" role="form" action="login" method="post">
                ...
                <a href='<?php echo base_url("users/new_passwd")?>'><small>¿Se te olvidó tu contraseña?</small></a>
                <p class="text-muted text-center"><small>¿No tiene una cuenta?</small></p>
                <a class="btn btn-sm btn-white btn-block" href="<?php echo base_url('users/users_register')?>">Crea una cuenta</a>
            </form>
