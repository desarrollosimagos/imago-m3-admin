...
--
-- Host: localhost
-- Generation Time: Sep 01, 2017 at 02:18 PM
...
(4, 'Pendrive', 'MLV499151733', 10, 168407.5, 8, 1, 1, 1, '2017-08-23'),
(7, 'Memoria Micro SD 32 GB', 'MLV499309776', 10, 168450.7, 9, 0, 1, 0, '2017-08-23');

-- --------------------------------------------------------

--
-- Table structure for table `productos_combinaciones`
--
...
--
-- Table structure for table `productos_tiendav`
--
...
--
-- Dumping data for table `productos_tiendav`
--

INSERT INTO `productos_tiendav` (`id`, `producto_id`, `tiendav_id`, `referencia`, `precio`, `cantidad`, `d_create`, `d_update`) VALUES
(25, 4, 2, 'MLV499151733', 0, 1, '2017-08-23 15:05:34', '2017-08-23 19:05:34'),
(27, 4, 3, '3r3wr3r3', 0, 1, '2017-08-23 15:05:34', '2017-08-23 19:05:34'),
(28, 7, 2, 'MLV499309776', 168450.7, 1, '2017-08-23 13:52:38', '2017-08-23 17:52:38'),
(29, 7, 4, 'ytrey3gdfw', 168450.7, 1, '2017-08-23 13:52:38', '2017-08-23 17:52:38');
...
--
-- Table structure for table `tienda_virtual`
--
...
--
-- Dumping data for table `tienda_virtual`
--

INSERT INTO `tienda_virtual` (`id`, `nombre`, `descripcion`, `url`, `tienda_id`, `tokens`, `expires_in`, `token_cliente`, `secret_api`, `url_callback`, `cliente_api_id`, `app_id`, `aplicacion_id`, `status`, `d_create`, `d_update`) VALUES
(2, 'tienda1', 'tienda de prueba 1', 'https://www.tienda1.com', 5, 'APP_USR-8637803471512011-082313-79357aff9a6873aa5aca33cb63d73d10__A_F__-269671730', '02:16:00', 'hgeftre', 'ESoCqzm905KA1BHLVpgTBIhaxxmkh8bi', 'http://www.tienda1.com', 'jrhtrwywer6y455gyeryw', '8637803471512011', 4, 1, '2017-08-29 13:39:59', '2017-08-29 13:39:59'),
(3, 'tienda2', 'tienda de prueba 2', 'https://www.tienda2.com', 0, 'vdfhfjfgft', '00:00:00', 'hgeftre', 'htrgetu45er', 'http://www.tienda2.com', 'jrhtrwywer6y455gyerywx', 'vrehyeufghefrthe', 5, 1, '2017-08-17 18:18:40', '0000-00-00 00:00:00'),
(4, 'tienda3', 'tienda de prueba 3', 'https://www.tienda3.com', 0, 'vdfhfjfgft', '00:00:00', 'hgeftre', 'htrgetu45er', 'http://www.tienda3.com', 'jrhtrwywer6y455gyerywx', 'vrehyeufghefrthe', 6, 1, '2017-08-17 18:19:15', '0000-00-00 00:00:00'),
(5, 'tienda4', 'tienda de prueba 4', 'https://www.tienda4.com', 0, 'vdfhfjfgft', '00:00:00', 'gfsdgdf', 'htrgetu45er', 'http://www.tienda4.com', 'jrhtrwywer6y455gyerywx', 'vrehyeufghefrthe', 4, 1, '2017-08-21 14:18:12', '2017-08-21 14:18:12'),
(6, 'tienda5', 'tienda de prueba 4', 'https://www.tienda5.com', 0, 'bdfh we', '00:00:00', 'hgeftre', 'ghgfdh', 'http://www.tienda5.com', 'jrhtrwywer6y455gyerywx', 'gfesrfwafsgqewetrwet', 6, 1, '2017-08-21 14:17:59', '0000-00-00 00:00:00'),
(7, 'tienda6', 'tienda de prueba 6', 'https://www.tienda6.com', 7, '', '00:00:00', '', '', '', '', '', 4, 1, '2017-08-29 13:41:44', '0000-00-00 00:00:00'),
...
(22, 'J-18379614-2', 'TIENDA15', 'dirección quince', '+5804168464923', 1, '2017-08-30 19:08:42', '2017-08-30 19:08:42');
...
--
-- Dumping data for table `users_tiendas`
--
...
--
-- Constraints for table `tienda_virtual`
--
