...
--
-- Host: localhost
-- Generation Time: Aug 15, 2017 at 03:06 PM
...
(4, 'producto1', 'producto1', 10, 141584.4, 8, 5, 1, 1, 1, '2017-08-15'),
(5, 'producto2', 'producto2', 11, 155742.84, 9, 3, 1, 1, 0, '2017-08-15'),
(6, 'producto3', 'producto3', 11, 155742.84, 10, 4, 0, 1, 1, '2017-08-15');
...
CREATE TABLE IF NOT EXISTS `tienda` (
  ...
  `aplicacion_id` varchar(200) NOT NULL,
  `status` int(11) NOT NULL,
  `d_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `d_update` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`)
...
INSERT INTO `tienda` (`id`, `nombre`, `descripcion`, `url`, `tokens`, `token_cliente`, `secret_api`, `url_callback`, `cliente_api_id`, `aplicacion_id`, `status`, `d_create`, `d_update`) VALUES
(1, 'Tienda1', 'Tienda de prueba 1', 'www.tienda1.com', '', '', '', '', '', '', 1, '2017-08-15 13:49:23', '0000-00-00 00:00:00'),
(2, 'Tienda2', 'Tienda de prueba 2', 'www.tienda2.com', '', '', '', '', '', '', 1, '2017-08-15 13:49:23', '0000-00-00 00:00:00'),
(3, 'Tienda3', 'Tienda de prueba 3', 'www.tienda3.com', '', '', '', '', '', '', 1, '2017-08-15 13:49:23', '0000-00-00 00:00:00'),
(4, 'Tienda4', 'Tienda de prueba 4', 'www.tienda4.com', '', '', '', '', '', '', 1, '2017-08-15 13:49:23', '0000-00-00 00:00:00'),
(5, 'Tienda5', 'Tienda de prueba 5', 'www.tienda5.com', '', '', '', '', '', '', 1, '2017-08-15 13:49:23', '0000-00-00 00:00:00'),
(8, 'tienda6', 'tienda de prueba 6', 'www.tienda6.com', 'vdfhfjfgft', 'hgeftre', 'htrgetu45er', 'hgfrujtruty', 'jrhtrwywer6y455gyerywx', 'gdfghr345', 1, '2017-08-15 18:23:41', '0000-00-00 00:00:00'),
(9, 'tienda7', 'tienda de prueba 7', 'www.tienda7.com', '', '', '', '', '', '', 1, '2017-08-15 18:35:38', '0000-00-00 00:00:00'),
(10, 'tienda8', 'tienda de prueba 8', 'http://www.tienda8.com', '', '', '', '', '', '', 1, '2017-08-15 18:36:52', '0000-00-00 00:00:00'),
(11, 'tienda9', 'tienda de prueba 9', 'https://www.tienda9.com', 'vdfhfjfgft', 'hgeftre', 'htrgetu45er', 'hgfrujtruty', 'jrhtrwywer6y455gyerywx', 'gdfghr345', 1, '2017-08-15 18:38:08', '0000-00-00 00:00:00'),
(12, 'tienda10', 'tienda de prueba 10', 'https://www.tienda9.com', 'vdfhfjfgft', 'hgeftre', 'htrgetu45er', 'http://www.tienda10.com', 'jrhtrwywer6y455gyerywx', 'gdfghr345', 1, '2017-08-15 18:42:27', '0000-00-00 00:00:00'),
(13, 'producto11', 'tienda de prueba 11', 'http://www.tienda11.com', '', '', '', 'http://www.tienda11.com', '', '', 1, '2017-08-15 18:46:40', '0000-00-00 00:00:00');
...
(10, 'admin@gmail.com', 'pbkdf2_sha256$12000$a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3', 'admin', 'admin', 1, 1, 1, '2017-08-15 16:20:32', '2017-08-15 16:20:32'),
...
ALTER TABLE `productos`
  ADD CONSTRAINT `productos_ibfk_1` FOREIGN KEY (`unidad_medida`) REFERENCES `measurement_units` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `productos_ibfk_2` FOREIGN KEY (`tienda_id`) REFERENCES `tienda` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
